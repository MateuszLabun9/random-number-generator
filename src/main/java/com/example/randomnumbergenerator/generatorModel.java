...
public class generatorModel {
    ...
    public void generateRandomNumbers() {
        ...
        samplesArray = distribution.sample(numSamples);
        String[] strArray = Arrays.stream(samplesArray)
                .mapToObj(String::valueOf)
                .toArray(String[]::new); // String conversion
        ...
        Arrays.stream(strArray)
                ...
                .forEach((k, v) -> distributionValuesMap.put(Integer.parseInt(k), String.valueOf(v.size())));
    }
